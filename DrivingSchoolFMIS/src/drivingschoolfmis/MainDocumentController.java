...
public class MainDocumentController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        nameLbl.setText(DrivingSchoolFMIS.schoolName + " Driving School" +  " (PAMSEU IMS)");
    ...
    private void setLabels() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                prevImgFile = new File("img/photo.jpg");
                ...
                image = new Image("file:img/photo.jpg", 150, 200, true, true);
    ...
    private void setApplicationCloseConfirmation() {
        ...
        StageManager.ParentStage.setOnCloseRequest(event -> {
            Alert alert = new Alert(Alert.AlertType.CONFIRMATION,
                    username + "! Are you sure to exit the IMS");
